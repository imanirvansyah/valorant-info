...
export const WeaponsContainer = () => {
    ...
    return (
        <div className="container mx-auto p-8 mt-24 grid grid-cols-4 gap-3">
            ...
            {data && data?.data?.data.map((weapon: any) => (
                <div key={weapon.uuid} className="p-3 border-white border mb-3 hover:bg-brand cursor-pointer transition ease-in-out duration-200">
