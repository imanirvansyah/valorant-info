...
export const WeaponsContainer = () => {
  ...
  return (
    <div className="container mx-auto p-8 mt-24 grid grid-cols-1 md:grid-cols-3 gap-3">
      <div className="">
      ...
      {data && data?.data?.data.map((weapon: IWeapons) => (
        <Link href={`weapons/${weapon.uuid}`} key={weapon.uuid}>
          <div className="p-3 border-white h-full flex items-center justify-center border mb-3 hover:bg-[rgba(255,255,255,0.5)] cursor-pointer transition ease-in-out duration-200 ">
