...
export const HeaderDetail = ({ title, imgUrl, breadcrumbs, roleImg }: IHeaderDetailProps) => {
  return (
    <div className="px-4  md:p-12 mx-auto relative h-72 xl:h-[400px]">
      <div className="absolute top-0 left-0 w-screen h-72 xl:h-[400px] -z-10 bg-img" style={{ backgroundImage: `url('${imgUrl}')`, backgroundSize: "cover", backgroundPosition: "center" }}></div>
